        ...
        return (
            <div className="front-header">
                <div className="main">
                    ...
                    <p>
                        I like to explore the world, take <a className="pictures" href="//bysem.me">pictures</a>, talk about games & technology, and so much more.
					</p>
                    <p>
                        If you would like to contact me, you can! Try trough <a className="twitter" href="//link.sems.dev/twitter">Twitter</a>, <a className="linkedin" href="//link.sems.dev/linkedin">LinkedIn</a>, <a className="github" href="//link.sems.dev/gh">Github</a>, or email <a className="me" href="mailto:me@sems.dev">me@sems.dev</a>. Want to verify if it is really me? Check the following <a download className="gpg key" href="/publickey.me@sems.dev.asc">GPG</a> and <a download className="ssh key" href="/sems.main.pub">SSH</a> keys <span role="img" aria-label="waving hand">🔑</span>
                    </p>
                </div>
            </div>
        )
