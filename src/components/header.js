    ...
    return (
      <div className="front-header">
        <div className="main">
          ...
          <p>
            My name is <span className="me">Sem Spanhaak</span>, currently doing my pre-master at <a className="uu" href="https://www.uu.nl/">Utrecht University</a>, as part of my BSc in Software Engineering at <a className="windes" href="//windesheim.nl/">Windesheim</a>. I also did part of my studies at <a className="lnu" href="//lnu.se/en">Linnaeus University</a>. Besides school, I work as a mobile app engineer at <a className="akyla" href="//akyla.nl/">Akyla</a>. 
          </p> 
          <p>
