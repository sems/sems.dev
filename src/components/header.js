    ...
    return (
      <div className="front-header">
        <div className="main">
          ...
          <p>
            People I've worked for previously are <a className="wehkamp" href="//wehkamp.nl/">Wehkamp</a>, <a className="akyla" href="//akyla.nl/">Akyla</a>, <a className="creative-orange" href="//creativeorange.nl/">Creative Orange</a>, <a className="e-active" href="//e-active.nl/">E-Active</a>, <a className="landstede" href="//landstedembo.nl/">Landstede</a>, <a className="azerty" href="//azerty.nl/">Azerty</a>, and <a className="dielle" href="//diellepelletkachel.nl/">Dielle</a>. I completed internships at <a className="wehkamp" href="//wehkamp.nl/">Wehkamp</a>, <a className="zon" href="//zonneplan.nl/">Zonneplan</a>, <a className="akyla" href="//akyla.nl">Akyla</a>, <a className="iq" href="//iqmedia.nl/">IQ-Media</a>, and <a className="egm" href="//epicode.nl/">Epicode</a>. 
					</p>
          <p>
