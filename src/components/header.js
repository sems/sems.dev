    ...
    return (
      <div className="front-header">
        <div className="main">
          ...
          <p>
            I like to explore the world, take <a className="me" href="//unsplash.com/@semspam">pictures</a> while doing it. Also love to talk about games & technology, and so much more.
					</p>
          <p>
